  ...
  return (
    <div className="bg-primary/5 rounded-xl overflow-hidden">
      <div className="bg-[#104127]/10 px-4 py-2 flex items-center gap-2">
        <TrendingUp className="w-4 h-4 text-[#104127]" />
        <h4 className="font-bold text-[#104127] text-sm">Citation Potential</h4>
      </div>
      ...
      <div className="p-4 space-y-4">
        <div className="grid grid-cols-2 gap-4">
          ...
          {/* Citation Rate - Percentage Only */}
          <div className="bg-white/40 rounded-lg p-3 flex flex-col items-center justify-center text-center w-full space-y-2">
            <span className="text-[10px] text-gray-500 uppercase tracking-wider">
              Citation Rate
            </span>
            <span className="text-2xl font-bold font-poppins text-blue-600">
              {data.citation_rate}%
            </span>
          </div>
        </div>

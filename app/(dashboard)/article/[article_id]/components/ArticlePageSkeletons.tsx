...
export const EditorSkeleton = () => (
  <div className="bg-white rounded-xl p-6 space-y-8 font-inter h-full overflow-y-auto no-scrollbar">
    {/* Toolbar Placeholder */}
...
export const InsightsSkeleton = () => (
  <div className="bg-white rounded-xl p-4 h-full overflow-y-auto no-scrollbar space-y-6 font-inter">
    {/* Tabs Placeholder */}
